...
export const drawArtist = async (id)=>{
  ...
  tracksList.innerHTML = topSongs.data.data.reduce((acc, track) => acc + tracklistTemplate(track),"");
  ...
  albumsList.innerHTML = artistAlbums.data.data.sort((a,b) => b.fans - a.fans)
                                                .slice(0,4)
  ...
  artistList.innerHTML = relatedArtists.data.data.sort((a,b) => b.nb_fan - a.nb_fan)
                                                 .slice(0,8)
